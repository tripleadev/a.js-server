...
var App = /** @class */ (function () {
    function App(config) {
        this.expressInstance = express_1.default();
        ...
        this.expressInstance.use(cors_1.default());
        this.features = [];
        ...
        for (var _b = 0, _c = this.features; _b < _c.length; _b++) {
            var feature = _c[_b];
            var featureRouter = express_1.default.Router();
            for (var _d = 0, _e = feature.featureInfo.routeList; _d < _e.length; _d++) {
                var route = _e[_d];
                if (route.method === 'GET') {
